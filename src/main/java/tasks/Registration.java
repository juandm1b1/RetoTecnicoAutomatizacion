...
public class Registration implements Task {
    ...
    public Registration(String strFirstName, String strLastName, String strEmail, String strMonthOfBirth, String strDayOfBirth, String strYearOfBirth, String strCity, String strCodPostal, String strPassword, String strConfirmPassword) {
    ...
    public static Registration signUp(String strFirstName, String strLastName, String strEmail, String strMonthOfBirth, String strDayOfBirth, String strYearOfBirth, String strCity, String strCodPostal, String strPassword, String strConfirmPassword) {
        return Tasks.instrumented(Registration.class,strFirstName,strLastName,strEmail,strMonthOfBirth,strDayOfBirth,strYearOfBirth,strCity,strCodPostal,strPassword,strConfirmPassword);
    }
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(Enter.theValue(strFirstName).into(RegistrationPages.INPUT_FIRSTNAME),
                ...
                Enter.theValue(strCity).into(RegistrationPages.SELECT_CITY),
                Hit.the(Keys.ARROW_DOWN).into(RegistrationPages.SELECT_CITY),
                Hit.the(Keys.ENTER).into(RegistrationPages.SELECT_CITY),

                Enter.theValue(strCodPostal).into(RegistrationPages.INPUT_POSTAL_COD),
